...
🌟 Features
    ...
    - 📇 Addresses - Store contact information
...
⌨️ Full Keyboard Navigation
    ...
    - A Add new entry
    - E Edit selected entry (opens in Notepad/text editor!)
...
- Side-by-side layout: entries on left, content on right.
- Clean margins and alignment.
- Title-based organization for other categories.
...
Issue: Categories Not Displaying Margin
- Fixed! ✅ All elements are now properly aligned.

Issue: Can't Edit Text Inline
- Fixed! ✅ Now opens Notepad/text editor for full editing capability.

Issue: Redundant Titles in Content
- Fixed! ✅ Titles only show in sidebar for Expenses/Addresses/Shopping/To-Do.
